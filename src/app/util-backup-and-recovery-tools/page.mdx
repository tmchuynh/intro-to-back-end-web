...
- [mysqldump](#mysqldump)
- [Redis Backup Tools](#redis-backup-tools)
- [Percona XtraBackup](#percona-xtrabackup)
- [WAL-E / WAL-G](#wal-e--wal-g)
- [Restic](#restic)
- [Borg Backup](#borg-backup)
- [Bacula](#bacula)
- [Amanda](#amanda)
- [Cloud-Specific Backup Tools](#cloud-specific-backup-tools)
- [Best Practices for Database Backups](#best-practices-for-database-backups)
