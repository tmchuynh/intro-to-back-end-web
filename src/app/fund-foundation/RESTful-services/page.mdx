...
If you haven't already, look through [HTTP Protocol](/fund-foundation/HTTP-protocol) to understand the HTTP protocol, which is the foundation of RESTful services, and [Web Server Basics](/fund-foundation/web-server-basics) to learn about web servers and how they interact with clients.

### Immediate Actions

| Priority   | Action                                                                              | Purpose                                                            |
| ---------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **High** | [Database Selection Criteria](/db-database-selection-criteria)                    | Introduction to database categories and performance considerations |
...
| **Medium** | [Set up a Package Manager](/db-database-starter-kit/package-managers)               | Essential tooling for project management and dependency handling   |
| **Medium**    | [Set up development environment](/db-environment-setup)                             | Essential to be able to run the code examples in this course       |
