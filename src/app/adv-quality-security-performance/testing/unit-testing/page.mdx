...
```java title="src/main/java/Calculator.java"
class Calculator {
...
```java title="src/test/java/CalculatorTest.java"
...
```python title="test_calculator_unittest.py"
import unittest
def add(a, b):
    return a + b
...
```javascript title="tests/selenium/google-search.test.js"
...
```javascript title="tests/cucumber/step-definitions/calculator-steps.js"
...
```java title="src/test/java/CalculatorSteps.java"
class Calculator {
    public int add(int a, int b) {
        return a + b;
    }
...
```ruby title="features/step_definitions/calculator_steps.rb"
