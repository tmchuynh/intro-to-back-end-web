...
```python title="app/extensions.py"
...
```python title="app/crud/user_crud.py"
...
```python title="app/crud/bulk_operations.py"
...
```python title="app/routes/user_routes.py"
# Query all users
...
```python title="app/routes/advanced_queries.py"
...
```python title="app/routes/analytics.py"
...
```python title="app/routes/pagination.py"
...
```python title="app/routes/sorting.py"
...
```python title="app/routes/relationship_queries.py"
...
```python title="app/routes/complex_queries.py"
...
```python title="app/utils/transactions.py"
from sqlalchemy import create_engine
from sqlalchemy.orm import sessionmaker
# Create an engine to connect to a SQLite database
engine = create_engine('sqlite:///example.db')
