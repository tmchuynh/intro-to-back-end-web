...
interface TaskCreationAttributes extends Optional<TaskAttributes, 'id' | 'description' | 'dueDate' | 'completed' | 'createdAt' | 'updatedAt'> {}
...
[Next: Backend API Development →](/proj-to-do-list-app/03-backend-api)
