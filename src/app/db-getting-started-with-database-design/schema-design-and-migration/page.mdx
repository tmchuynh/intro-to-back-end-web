...
| ---------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| **High**   | [Relational Database Concepts](/db-different-databases-and-their-foundational-concepts/relational-databases)   | Understand the foundational concepts of relational databases |
| **High**   | [Non-Relational Database Concepts](/db-different-databases-and-their-foundational-concepts/db-noSQL-databases) | Understand the foundational concepts of relational databases |
| **Medium** | [Introduction to Object Relational Mappers (ORMs)](/db-object-relational-mappers-fundamentals)                 | Understand the foundational concepts of relational databases |

### Optional Actions

| Action                                                                                                        | Purpose                                             |
| ------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| [Documentation and Schema Visualization Tools](/util-documentation-and-schema-visualization-tools)            | Master core database concepts and design principles |
| [Schema Migration and Version Control Tools](/util-schema-migration-and-version-control)                      | Master core database concepts and design principles |
| [Object Relational Mapping (ORM) and Query Builder Tools](/util-object-relational-mapping-and-query-builders) | Master core database concepts and design principles |
